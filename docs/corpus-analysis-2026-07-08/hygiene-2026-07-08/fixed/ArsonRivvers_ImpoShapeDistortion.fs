/*{
    "DESCRIPTION": "Fractal kaleidoscope distortion — warps the input video through one of 10 iterative symmetry transforms (rotation, hyperbolic, twist, polar) with adjustable complexity and symmetry.",
