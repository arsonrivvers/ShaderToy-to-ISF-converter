...
final class CoPilotResponseParserTests: XCTestCase {
    ...
    func testRawInnerNoEnvelope() throws {
        let r = try CoPilotResponseParser.fixResult(fromClaudeStdout: inner); XCTAssertEqual(r.explanation, "e")
    }
    ...
    func testSuggestionsParse() throws {
        ...
        let r = try CoPilotResponseParser.suggestions(fromClaudeStdout: env); XCTAssertEqual(r.ideas[0].kind, "design")
    }
