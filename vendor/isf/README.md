...
To re-bundle after `npm install interactive-shader-format`:
    ...
    npx esbuild isf-entry.js --bundle --format=iife \
      --outfile=../../App/TrueISFEditor/Resources/isf.bundle.js

The committed bundle lives at `App/TrueISFEditor/Resources/isf.bundle.js`; the upstream
license at `App/TrueISFEditor/Resources/isf.LICENSE.txt`. `node_modules/` is gitignored.
